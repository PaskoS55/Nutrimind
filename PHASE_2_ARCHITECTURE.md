...
The catalog coverage subset is empty. No catalog, entity, ingredient matching, regulatory-exception engine, product filtering, portion or menu exists in Phase 3B2A.
